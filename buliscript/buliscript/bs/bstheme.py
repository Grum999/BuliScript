...
class BSTheme(object):
    ...
    def __init__(self):
        self.__theme = BSTheme.DARK_THEME
    ...
    def loadResources(self):
        ...
        if not Krita.activeWindow() is None:
            ...
            if palette.color(QPalette.Window).value() <= 128:
                ...
                self.__theme = BSTheme.LIGHT_THEME
    ...
    def style(self, name):
        ...
        if name in BSTheme.STYLES_SHEET[self.__theme]:
            return BSTheme.STYLES_SHEET[self.__theme][name]
        elif self.__theme != BSTheme.DARK_THEME and name in BSTheme.STYLES_SHEET[BSTheme.DARK_THEME]:
            return BSTheme.STYLES_SHEET[BSTheme.DARK_THEME][name]
        return ''
